...
| `--version <tag>` | `OPENCODE2API_VERSION` | Release tag，例如 `v0.7.0` |
...
```bash
curl -fsSL https://raw.githubusercontent.com/6Kmfi6HP/opencode2api/main/scripts/install.sh | bash -s -- --version v0.7.0

OPENCODE2API_VERSION=v0.7.0 OPENCODE2API_INSTALL_DIR="$HOME/bin" bash install.sh --no-modify-path
```

发布前用于检查资产名和下载地址：

```bash
OPENCODE2API_VERSION=v0.7.0 bash scripts/install.sh --check
```
...
```powershell
# 只打印检测结果和下载地址
irm https://raw.githubusercontent.com/6Kmfi6HP/opencode2api/main/scripts/install.ps1 | iex -Version v0.7.0 -CheckOnly

# 固定版本，不修改用户 PATH
& C:\path\to\install.ps1 -Version v0.7.0 -InstallDir "$HOME\.opencode2api\bin" -NoModifyPath
```
...
- `opencode2api_v0.7.0_linux_amd64.tar.gz`
- `opencode2api_v0.7.0_linux_arm64.tar.gz`
- `opencode2api_v0.7.0_linux_arm_v7.tar.gz`
- `opencode2api_v0.7.0_darwin_amd64.tar.gz`
- `opencode2api_v0.7.0_darwin_arm64.tar.gz`
- `opencode2api_v0.7.0_windows_amd64.tar.gz`
- `opencode2api_v0.7.0_windows_arm64.tar.gz`
- `opencode2api_v0.7.0_freebsd_amd64.tar.gz`
- `opencode2api_v0.7.0_freebsd_arm64.tar.gz`
...
```bash
tar -xzf opencode2api_v0.7.0_linux_amd64.tar.gz
./opencode2api_v0.7.0_linux_amd64/opencode2api -version
```

Windows：

```powershell
tar -xzf .\opencode2api_v0.7.0_windows_amd64.tar.gz
.\opencode2api_v0.7.0_windows_amd64\opencode2api.exe -version
```

...
| `text_only_models` | Optional extra model prefixes forced to text-only on top of the models.dev input-modality data (default: none); images are silently downgraded to an `[image attached]` text annotation. |
